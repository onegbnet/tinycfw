...
<link rel="stylesheet" href="https://{{CDN_HOST}}/gh/onegbnet/tinycfw@5dbb6c77de3d855d4873c8bc863263245a5aa9a2/mailgunfire/view.min.css">
</head>
<body>
...
<script>(function(){var b="https://{{CDN_HOST}}/gh/onegbnet/tinycfw@5dbb6c77de3d855d4873c8bc863263245a5aa9a2/mailgunfire";var s=["en","eo","fr","de","es","it","nl","da","zh-cn","zh-tw","ja","ko","ms","vi","th","ta","my","uk","he","ar"];var d="en";function load(l){return new Promise(function(r,j){var x=document.createElement('script');x.src=b+'/i18n-'+l+'.min.js';x.onload=function(){r(l)};x.onerror=function(){j(new Error('i18n-'+l+' failed'))};document.head.appendChild(x)})}var init=(function(){var g=window["INITIAL_LANG"];if(typeof g==='string'&&s.indexOf(g)>=0)return g;return typeof detectLang==='function'?detectLang(s):d})();if(s.indexOf(init)<0)init=d;window.LangBundle={initial:init,ready:load(init),load:load}})();</script>
<script src="https://{{CDN_HOST}}/gh/onegbnet/tinycfw@5dbb6c77de3d855d4873c8bc863263245a5aa9a2/mailgunfire/client.min.js"></script>
</body>
</html>
`;
